...
export const CheckPopupForm = ({data, onClose, viewOnly}: PopupFormProps) => {
                        ...
                        <div className="down d-flex justify-content-between">
                            <div className="downLeft">
                                ...
                                <div className="form-group">
                                    ...
                                    <div>
                                        <div
                                            className="text-primary m-1 fw-bold ">{data.followUpResult ? data.followUpResult : ""}</div>
                                        {data.followUpResult && data.followUpResult === "存款" && (
                                            <div>
                                                <label className="fw-bold"
                                                       htmlFor="formDepositCurrency">存款貨幣</label>
                            ...
                            <div className="downRight">
                                ...
                                <div className="form-group">
                                    <label className="fw-bold" htmlFor="ApprovalResults">批核結果</label>
                                    <p className="m-1 text-primary fw-bold">{data.mgtFollowUpResult?data.mgtFollowUpResult:data.creditFollowUpResult?data.creditFollowUpResult:""}</p>
                                    <label className="fw-bold" htmlFor="ApprovalResults">備註</label>
                                    <p className="m-1 text-primary fw-bold">{data.mgtFollowUpResult?data.mgtRemark:data.creditFollowUpResult?data.creditRemark:""}</p>
                                    <label className="fw-bold" htmlFor="ApprovalResults">跟進人</label>
                                    <p className="m-1 text-primary fw-bold">{data.mgtFollowUpResult?data.mgtFollowUpPerson:data.creditFollowUpResult?data.creditFollowUpPerson:""}</p>
                                    <label className="fw-bold" htmlFor="ApprovalResults">批核日期</label>
                                    <p className="m-1 text-primary fw-bold">{data.mgtFollowUpResult?data.mgtFollowUpDate:data.creditFollowUpResult?data.creditFollowUpDate:""}</p>
                                </div>
                            </div>
                        </div>
                    </div>
